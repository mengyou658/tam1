        ...
        <div class="left rightbar">
            <div class="rightbar_top">
                    ...
                    <div class="rightbar_bottom">
                    	<ul class="xingxiang">
                            <?php if(is_array($catePics)): $k = 0; $__LIST__ = $catePics;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><li><a href="#"><img src="<?php echo ($vo["attachment"]); ?>"/></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                        </ul>
                    </div>
                </div>
            </div>
