        	...
        	<div class="neiyecontent_top">
                ...
                <div class="left rightbar">
                	<div class="rightbar_top">
                    	<h2><a href="news.html">时尚资讯</a></h2>
                        <ul>
                        	<li><a href="index.html">首页</a></li>
                            <li><a href="news.html">时尚资讯</a></li>
                        </ul>
                    ...
                    <div class="rightbar_bottom">
                    	<div class="zixuncontent">
                            <?php if(is_array($catePics)): $k = 0; $__LIST__ = $catePics;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><h6><?php echo ($vo["name"]); ?></h6>
                            <div class="time"><?php echo ($vo["postdate"]); ?></div>
                            <div class="zixun_img"><img src="<?php echo ($vo["attachment"]); ?>"/></div>
                            <?php echo ($cate[$k-1]["content"]); endforeach; endif; else: echo "" ;endif; ?>
                        </div>
                    </div>
                </div>
            </div>
