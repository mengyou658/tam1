...
<p class="fl song"><?php echo ($sys["top_location"]); ?></p>
      ...
      <div class="content fl">
          ...
          <h2 class="Roman fl ">Tiles</h2>
            <div CLASS="mbx fr"><a href="__APP__">HOME</a><span> > </span><a href="__APP__/title.html">Tiles</a><span> > </span><a href="__APP__/title/<?php echo ($cateInfo["id"]); ?>.html"><?php echo ($cateInfo["name"]); ?></a></div>
          </div>
      <ul class="granite-menu">
		  <?php if(is_array($cate)): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="__APP__/title/<?php echo ($vo["id"]); ?>.html" <?php if($vo['id'] == $cateInfo['id']): ?>style="font-weight:bold"<?php endif; ?>><?php echo ($vo["name"]); ?></a><i></i></li><?php endforeach; endif; else: echo "" ;endif; ?>
