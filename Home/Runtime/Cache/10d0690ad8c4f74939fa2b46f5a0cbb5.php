        ...
        <div class="left rightbar">
            <div class="rightbar_top">
                    ...
                    <div class="rightbar_bottom">
                        <?php if(is_array($a)): $i = 0; $__LIST__ = $a;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><img src="<?php echo ($vo["attachment"]); ?>"/><?php endforeach; endif; else: echo "" ;endif; ?>
                    </div>
                </div>
            </div>
