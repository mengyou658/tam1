...
<div  class="neiye_content width1">
    ...
    <!--content-->
                    ...
                    <div class="rightbar_bottom">
                        <?php if(is_array($a)): $i = 0; $__LIST__ = $a;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="pro1"><a href="#"><img src="<?php echo ($vo["attachment"]); ?>"/></a></div><?php endforeach; endif; else: echo "" ;endif; ?>
                    </div>
