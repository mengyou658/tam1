...
class doAction
{
	...
	public function _upload() 
	{
		...
		$updir_b = $_SERVER['DOCUMENT_ROOT'] ."__ROOT__/Attachments/b/".date("Ymd")."/";
		$updir_s = $_SERVER['DOCUMENT_ROOT'] ."__ROOT__/Attachments/s/".date("Ymd")."/";
		...
		$upload -> savePath =  "__ROOT__/Attachments/b/".date("Ymd")."/";
		$upload -> thumb = true;
		$upload -> thumbPrefix = '';
