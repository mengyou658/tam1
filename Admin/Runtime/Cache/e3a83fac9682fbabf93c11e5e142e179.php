...
<form method="post" name="form1" action="__URL__/update"  enctype="multipart/form-data">
<div class="list">
	<?php if(is_array($groupRs)): $gkey = 0; $__LIST__ = $groupRs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$groupRs): $mod = ($gkey % 2 );++$gkey;?><div class="RootName" onclick="fold('<?php echo ($gkey); ?>');" title="点击可折叠栏目"><?php echo ($groupRs["name"]); ?></div>
